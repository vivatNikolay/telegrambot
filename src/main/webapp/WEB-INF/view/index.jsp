                ...
                <table class="table">
                    ...
                    <c:forEach var="showAllCities" items="${showAllCities}" varStatus="status">
                        <tr class="info">
                                ...
                                <td><a href="${pageContext.request.contextPath}/cities/view?id=${showAllCities.id}"><button type="button" class="btn btn-success"><b>Посмотреть</b></button></a></td>
                                <td><a href="${pageContext.request.contextPath}/cities/delete?id=${showAllCities.id}"><button type="button" class="btn btn-danger"><b>Удалить</b></button></a></td>
                        </tr>
                    </c:forEach>
                </table>
            </div>
